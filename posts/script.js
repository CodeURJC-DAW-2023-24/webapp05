...
toggleThemeBtn.addEventListener('click', () => {
  ...
  if (document.documentElement.classList.contains('darkTheme')) {
    ...
    document.getElementsByTagName('html').classList = "darkTheme"
    document.getElementById("logo").src = "assets/logo_oscuro.jpg";
  } else {
    //localStorage.setItem('theme', 'light');
    document.getElementsByTagName('html').classList = "lightTheme"
